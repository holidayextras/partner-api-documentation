...
## How will the customer pay for their booking?

Your customer pays you, and you issue any customer-facing receipt or invoice. Holiday Extras invoices you at month end for bookings made through your API credentials.

Your commission is returned in the booking response as `pricing.commission`.

## Who refunds the customer after a cancellation?

You refund the customer through your own payment process, based on the outcome returned when the cancellation is confirmed. Holiday Extras reflects the confirmed refund amount through your invoices.

## Who manages customer support, amendments, and cancellations?
